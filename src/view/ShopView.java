...
public class ShopView extends JFrame implements ActionListener, KeyListener  {
	...
	public ShopView() {
		...
		btnNewButtonDelete = new JButton("4. Eliminar producto");
	...
	private void openCashView() {
	    // Invoca un método para abrir la vista de contar caja
	    CashView cashView = new CashView();
	    cashView.setVisible(true);
	}

private void openProductView(int option) {
    // Invoca un método para abrir la vista de añadir producto, añadir stock o eliminar producto
